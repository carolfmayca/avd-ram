...
detectados automaticamente da máquina; **C** (carga) vem da flag `--carga`. Como A×B é
fixo por máquina, cada operador roda o script duas vezes por máquina (repouso e pesada);
entre os integrantes as 8 combinações são cobertas.
